...
- [*] Explain what a token is used for.
  A token is used to authenticate that the user has is allowed access to protected resources that require authentication
- [*] What steps can you take in your web apps to keep your data secure?
  Require authentication and use Protected Routes.
- [*] Describe how web servers work.
  Webservers utilize Domain names and URLs to serve up information hosted on a vast network of computers called 'web servers'. 
